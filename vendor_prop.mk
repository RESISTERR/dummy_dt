...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    persist.vendor.ims.enable_decoder_feedback=1 \
    ...
    ro.bootimage.build.date.utc=1666950060 \
    ro.bootimage.build.date=Fri \
    Oct \
    16:41:00 \
    WIB \
    2022 \
    ro.bootimage.build.fingerprint=Redmi/spes/spes:12/SKQ1.211103.001/V13.0.2.0.SGKIDXM:user/release-keys \
    ...
    ro.odm.build.date.utc=1666950060 \
    ro.odm.build.date=Fri \
    ro.odm.build.fingerprint=Redmi/spes/spes:12/SKQ1.211103.001/V13.0.2.0.SGKIDXM:user/release-keys \
    ro.odm.build.id=SKQ1.211103.001 \
    ro.odm.build.tags=release-keys \
    ro.odm.build.type=user \
    ro.odm.build.version.incremental=V13.0.2.0.SGKIDXM \
    ...
    ro.product.build.date.utc=1666950060 \
    ro.product.build.date=Fri \
    ro.product.build.fingerprint=Redmi/spes/spes:12/SKQ1.211103.001/V13.0.2.0.SGKIDXM:user/release-keys \
    ro.product.build.id=SKQ1.211103.001 \
    ro.product.build.tags=release-keys \
    ro.product.build.type=user \
    ro.product.build.version.incremental=V13.0.2.0.SGKIDXM \
    ro.product.build.version.release=12 \
    ro.product.build.version.release_or_codename=12 \
    ro.product.build.version.sdk=30 \
    ro.product.mod_device=spesn_id_global \
    ...
    ro.rom.zone=2 \
    ro.soc.model=SM6225 \
    ro.system_ext.build.date.utc=1666950060 \
    ro.system_ext.build.date=Fri \
    ro.system_ext.build.fingerprint=Redmi/spes/spes:12/SKQ1.211103.001/V13.0.2.0.SGKIDXM:user/release-keys \
    ro.system_ext.build.id=SKQ1.211103.001 \
    ro.system_ext.build.tags=release-keys \
    ro.system_ext.build.type=user \
    ro.system_ext.build.version.incremental=V13.0.2.0.SGKIDXM \
